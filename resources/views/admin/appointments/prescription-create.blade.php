    ...
    <div class="container mt-5">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form action="{{ route('admin.appointment.prescriptionStore') }}" method="POST">
                    @csrf
                    <div class="row g-3 mt-3">
                        <div class="col-md-12">
                            <label for="address" class="form-label">Prescription *</label>
                            <textarea class="form-control" id="address" name="prescription" rows="5">{{ $pre->prescription ?? '' }}</textarea>
                        </div>
                    </div>
